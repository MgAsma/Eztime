...
export class CreateNewProjectComponent implements OnInit {
  ...
  getPeopleGroup(){
    ...
    this.api.getData(`${environment.live_url}/${environment.people_list}?search_key=&page_number=1&data_per_page=2&pagination=TRUE&organization_id=${this.orgId}`).subscribe((data:any)=>{
      if(data){
